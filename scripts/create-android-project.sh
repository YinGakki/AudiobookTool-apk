...
ANDROID_DIR="android"
APP_ID="${1:-com.yourcompany.voicestudiopro}"

echo "Creating Android project in $ANDROID_DIR..."
...
# 创建基本目录结构
mkdir -p $ANDROID_DIR/app/src/main/{java/com/yourcompany/voicestudiopro,res/{layout,values},assets,python}
...
include ':app'
rootProject.name = "VoiceStudioPro"
EOF
...
echo "✅ Android project created successfully in $ANDROID_DIR"
